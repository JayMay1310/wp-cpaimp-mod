	...
	<tr>
		<td>
			<a href="<?php echo add_query_arg('do_product_action', 'redirect', get_permalink($post))?>" target="_blank" >
				<img src="<?php echo IM_PLUGIN_URL?>img/buy.png" alt="Еще подробнее <?php echo $post->post_title; ?>" height="25px"/>
			</a>
		</td>
		<td>
		</td>
		<td>
			...
			<a href="<?php echo get_permalink($relatedItem->ID) ?>" title="<?php echo $relatedItem->post_title; ?>" style="display: block;">
				<img src="<?php echo IM_PLUGIN_URL?>img/details.png" alt="Подробнее" />
			</a>
			<?php endif?>
		</td>
	</tr>
...
<?php
	$args = array(
		'numberposts'	=> IM_Config::init()->get('ps_row_limit'),
		'orderby'		=> 'rand',
		'post_type'		=> 'product',
		'post_status' => 'publish',
	...
	<table class="products-list">
		<tr>
			...
			<td style="text-align: left;">
				...
				<p class="products-details"><a href="<?php echo get_permalink($relatedItem->ID) ?>" title="<?php echo $relatedItem->post_title; ?>"><img src="<?php echo IM_PLUGIN_URL?>img/details.png" alt="Подробнее" /></a></p>
			</td>
			<?php } ?>
		</tr>
	</table>
